...
const POS = () => {
  ...
  const { cashRegister, cashRegisterDialogOpen, setCashRegisterDialogOpen, handleOpenCashRegister, handleCloseCashRegister } =
    useCashRegister();
  const {
    paymentDialogOpen,
  ...
  return (
    <div className="min-h-screen flex flex-row bg-black text-white">
      ...
      {/* Cart */}
      <aside className="w-full max-w-lg bg-neutral-900 shadow-xl border-l border-neutral-800 flex flex-col justify-between min-h-screen">
